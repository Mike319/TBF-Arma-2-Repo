...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "roadbarrierlarge": {"life_inv_roadbarrierlarge"};
			case "stripebarrier": {"life_inv_stripebarrier"};
			case "landmarker": {"life_inv_landmarker"};
			case "rightarrow": {"life_inv_rightarrow"};
			case "leftarrow": {"life_inv_leftarrow"};
		};
	};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_roadbarrierlarge": {"roadbarrierlarge"};
			case "life_inv_stripebarrier": {"stripebarrier"};
			case "life_inv_landmarker": {"landmarker"};
			case "life_inv_rightarrow": {"rightarrow"};
			case "life_inv_leftarrow": {"leftarrow"};
		};
	};
};
