...
switch (_className) do
{
	...
	case "Jonzie_Box_Truck": {400};
	case "Jonzie_Superliner": {450};
	case "Jonzie_Western": {500};
	...
	case "Land_CargoBox_V1_F": {750};
	case "Box_IND_Grenades_F": {350};
	case "B_supplyCrate_F": {700};
	case "sab_C130_H": {1000};
	case "sab_RobinDR400": {285};
	default {-1};
};