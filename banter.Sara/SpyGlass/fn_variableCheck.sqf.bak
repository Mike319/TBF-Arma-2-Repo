...
_badVariables = ["G-e-F","G-e-F_HackInit","G-e-F_HackInit.ini","spawn","personalarsenal","pa","JxMxE_hide","JME_Keybinds","JME_has_yet_to_fuck_this_shit","JME_deleteC","JME_Tele","JME_ANAL_PLOW","JME_M_E_N_U_initMenu","JME_M_E_N_U_hax_toggled","W_O_O_K_I_E_FUD_Pro_RE","W_O_O_K_I_E_FUD_Car_RE","W_O_O_K_I_E_FUD_Car_RE",
...
_checkThread = {
	{
		...
		if(!isNil "_var") then {
			...
			[[name player,getPlayerUID player,_x],"SPY_fnc_cookieJar",false,false] spawn life_fnc_MP;
