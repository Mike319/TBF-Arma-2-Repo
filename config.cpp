...
class CfgVehicles {
  ...
  {
    displayName = "NVA Long Range Radio";
    descriptionShort = "NVA long range radio 20km";
    maximumLoad = 100;
    mass = 120;
    //hiddenSelections[] = {"camo"};
    //hiddenSelectionsTextures[] = {"\task_force_radio_items\models\data\camo\backpack_green_co.paa"};
    model = "uns_backpacks\uns_nva_rto.p3d";
  };
  class tf_rt1523g_fabric: tf_rt1523g
  {
    displayName = "Army Long Range Radio";
    descriptionShort = "Army long range radio 20km";
    maximumLoad = 100;
    mass = 120;
    //hiddenSelections[] = {"camo"};
    //hiddenSelectionsTextures[] = {"\task_force_radio_items\models\data\camo\backpack_fabric_co.paa"};
    model = "uns_backpacks\uns_army_rto.p3d";
  };
...
class CfgWeapons
{
  ...
  class cg_tabletd: ItemRadio
  {
    displayName = "Tablet";
    descriptionShort = "Tablet";
    scope = 2;
    scopeCurator = 2;
    model = "\cg_atf_objects\Tablet_Device.p3d";
    picture = "\cg_atf_objects\data\UI\Tablet_Device_ca.paa";
    tf_prototype = 1;
    tf_range = 52000;
    tf_dialog = "";
    tf_encryptionCode = "tf_east_radio_code";
  ...
  TF_RADIO_IDS(tf_anprc152,AN/PRC-152)
    ...
    TF_RADIO_IDS(cg_tabletd,Tablet)
};
