...
class VirtualItems {
	...
	VITEMMACRO(oil_processed, "STR_Item_OilP", "oilProcessed", 6, -1, 3700, false, -1, "")
	...
	VITEMMACRO(iron_refined, "STR_Item_IronIngot", "ironRefined", 3, -1, 2500, false, -1, "")
...
class Licenses {
	...
	LICENSEMACRO(meth,"STR_License_Meth","meth",3000,true,"civ")
