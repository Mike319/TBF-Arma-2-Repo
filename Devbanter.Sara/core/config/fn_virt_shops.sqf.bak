...
switch (_shop) do
{
	...
	case "donator": {["Donator Market",["water","rabbit","apple","redgull","tbacon","lockpick","pickaxe","fuelF","peach","boltcutter","blastingcharge","zipties","storagesmall","storagebig","donuts","coffee","spikeStrip"]]};
	...
	case "cop": {["Cop Item Shop",["donuts","coffee","spikeStrip","water","rabbit","apple","redgull","fuelF","defusekit","bargate","cone","roadbarriersmall","roadbarrierlarge","stripebarrier","landmarker","rightarrow","leftarrow"]]};
