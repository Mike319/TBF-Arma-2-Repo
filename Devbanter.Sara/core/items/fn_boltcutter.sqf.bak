...
if(((nearestObject [[16019.5,16952.9,0],"Land_Dome_Big_F"]) == _building) && ((west countSide playableUnits) < 5)) exitWith {hint localize "There must be 5 cops online to rob";};
if(((nearestObject [[16019.5,16952.9,0],"Land_Research_house_V1_F"]) == _building) && ((west countSide playableUnits) < 5)) exitWith {hint localize "There must be 5 cops online to rob";};
