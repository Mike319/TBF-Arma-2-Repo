...
//_kassa = 100000; //The amount the shop has to rob, you could make this a parameter of the call (https://community.bi.../wiki/addAction). Give it a try and post below ;)
_action = [_this,2] call BIS_fnc_param;//Action name
 
if(side _robber != civilian) exitWith { hint "You can not rob this ATM!" };
if(_robber distance _shop > 4) exitWith { hint "You need to be within 4m of the ATM!" };
...
_chance = random(100);
if(_chance >= 95) then { hint "The ATM has a silent alarm, police has been alerted!"; [[1,format["ALARM! - Gasstation: %1 is being robbed!", _shop]],"life_fnc_broadcast",west,false] spawn life_fnc_MP; };
...
titleText[format["You have stolen $%1, now run like hell before you find holes in your rear!",[_kassa] call life_fnc_numberText],"PLAIN"];
