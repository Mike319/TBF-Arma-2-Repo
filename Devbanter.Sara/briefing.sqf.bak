...
player createDiarySubject ["The Banter Federation Infomation","Our Rules"];
...
*/
	...
	player createDiaryRecord["The Banter Federation Infomation",
		[
			"Information",
				"
				Website: www.TheBanterFederation.enjin.com<br/>
				Teamspeak: vs23.tserverhq.com:7165 <br>
				"
		]
	];
	...
	player createDiaryRecord["The Banter Federation Infomation",
		[
			"Our Rules/Laws",
				"
					Rule 1: No Illegal weapons in any city limits<br/>
					Rule 2: If you have a weapon in your hands the weapon will be taken away.<br/>
					Rule 3: Ifrits are illegal in any City.<br/>
					Rule 4: No flying below 150 Meters in any city<br/>
				"
		]
	];
	...
	player createDiaryRecord ["serverrules",
		[
			"Bannable Offenses",
				...
				4. Using a Lifting helicopter to lift vehicles that are not owned by you!(see 'Exploits')<br/>
				5. Being kicked 3 or more times.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["serverrules",
		[
			"Aviation",
				...
				2. Using Lift on any vehicle other than your own vehicle or asked to use lift on the owners vehicle..<br/>
				3. Flying below 150m over the city constantly. Once is illegal, more than that you risk crashing into the city, thus against server rules.<br/>
				4. Stealing helicopters without proper warning and significant time for the driver to lock the vehicle. If they land and run away without locking, fine, if they just get out and you get in before they get a chance to lock it, no no.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["serverrules",
		[
			"New Life Rule",
				...
				1. If you are killed you must wait 15 minutes before returning to the scene of your death. (Even if you can spawn close to your death, choose another spawn point.)<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Vehicles",
				...
				8. Please limit the amount of vehicles in your garage to 10 maximum.<br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Arresting and Ticketing",
				...
				3. If a civilian is wanted, you may arrest them. Do not kill them, unless the situation falls under the 'Use of Lethal Force' section.<br/>
				4. If you are arresting someone, you MUST read them their rights BEFORE moving them from the location.<br/>
				5. If the arrestee requests an attorney but cannot afford one, you must assign someone to represent them. Anyone can be an attorney.<br/><br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Weapons",
				...
				Any weapon bought from the gun store is a Legal Weapon for Civilians to carry with a permit<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Raiding/Camping",
				...
				1. In order to raid an area, the cops must have at least 3 officers involved, one of which must be a Sergeant or above.<br/>
				...
				8. If the raid is a failure (All officers die), the 30 minute timer still applies to those officers.<br/>
	...
	player createDiaryRecord ["illegalitems",
		[
			"Illegal Weapons",
				...
				5. Mk.18 ABR<br/>
				6. Sting SMG<br/>
				7. Any Silenced weapon (Taser)<br/>
				8. Any explosives<br/><br/>
				9. Any LMG
				10. Any Sniper Rifle
				"
		]
	...
	player createDiaryRecord ["illegalitems",
		[
			"Illegal Items",
				...
				3. Cannabis<br/>
				4. Marijuana<br/>
				5. Blasting Charge<br/>
				6. Bolt Cutters or Lockpicks<br/><br/>
				"
		]
	];
